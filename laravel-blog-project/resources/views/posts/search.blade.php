        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <ul class="space-y-2">
                        <li>
                            <a href="{{ route('posts.search', ['q' => request('q'), 'sort' => 'created_at', 'direction' => 'desc']) }}" 
                               class="text-blue-600 hover:underline">
                                Newest First
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('posts.search', ['q' => request('q'), 'sort' => 'created_at', 'direction' => 'asc']) }}" 
                               class="text-blue-600 hover:underline">
                                Oldest First
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('posts.search', ['q' => request('q'), 'sort' => 'title', 'direction' => 'asc']) }}" 
                               class="text-blue-600 hover:underline">
                                Title (A-Z)
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('posts.search', ['q' => request('q'), 'sort' => 'view_count', 'direction' => 'desc']) }}" 
                               class="text-blue-600 hover:underline">
                                Most Popular
                            </a>
                        </li>
        ...
        <div class="lg:col-span-3 space-y-6">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <p class="text-gray-500 mt-2">Found {{ $posts->total() }} result(s)</p>
                </div>
            </div>
            ...
            @else
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200 text-center">
                        ...
                        <a href="{{ route('posts.index') }}" class="mt-4 inline-block text-blue-600 hover:underline">View all posts</a>
                    </div>
                </div>
            @endif
        </div>
